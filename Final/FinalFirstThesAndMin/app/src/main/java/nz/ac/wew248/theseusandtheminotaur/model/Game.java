...
public class Game implements ISubject, IGame{
    private Wall[][] left;
    private Wall[][] up;
    ...
    private void checkWin() {
    	if(theseus.xAxis() == exit.xAxis() && theseus.yAxis() == exit.yAxis()) {
    		this.win = true;
    		inform();
    	}
    }
    ...
    private void checkLose() {
        if(theseus.xAxis() == minotaur.xAxis() && theseus.yAxis() == minotaur.yAxis()) {
            this.lose = true;
            inform();
        }
    }
